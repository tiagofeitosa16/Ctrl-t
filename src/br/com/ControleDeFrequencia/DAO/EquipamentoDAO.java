...
public class EquipamentoDAO implements PadraoDAO {
    ...
    public boolean inserir(Object objeto) {
        try {
            sql = "insert into equipamento(descricao, numero_tombamento, data_cadastro, estatus, inativo) values(?,?,?,?,?)";
    ...
    public boolean alterar(Object objeto) {
        try {
            sql = "update equipamento set descricao = ?, numero_tombamento = ?, data_cadastro = ?, estatus = ?, inativo = ? where codigo = ?";
    ...
    public Object selecionar(Object objeto) {
        try {
            int inativo;
            sql = "Select codigo, descricao, numero_tombamento, data_cadastro, estatus, inativo from equipamento where codigo = ?";
            stmt = Conexao.getInstance().getConexao().prepareStatement(sql);
    ...
    public void pesquisar(int opcao, String valor){
        String sqlTemp = "Select codigo, descricao, estatus from equipamento ";
